...
### 1. [Machine Learning Unlocks CRISPR-Cas9's "Hidden Menu"](https://www.nature.com/articles/s41467-026-69098-5)
...
### 2. [OpenHealth: 3,800-Star Open-Source Health AI Assistant](https://github.com/OpenHealthForAll/open-health)
...
### 3. [HealthChain: The "Middleware" for Medical AI Has Arrived](https://github.com/dotimplement/HealthChain)
...
| # | Type | Title | Link |
|---|------|-------|------|
| 1 | Open Source | TransformerCPI: Compound-Protein Interaction Prediction | [GitHub](https://github.com/lifanchen-simm/transformerCPI) |
| 2 | Open Source | DeepMicrobes: Metagenomic Species Classification | [GitHub](https://github.com/MicrobeLab/DeepMicrobes) |
| 3 | Open Source | Deep Learning in Bioinformatics Resource Collection | [GitHub](https://github.com/Bjoux2/DeepLearning-in-Bioinformatics) |
| 4 | Open Source | Doctor-Dok: Medical Data AI Parsing Framework | [GitHub](https://github.com/Doctor-One/doctor-dok) |
| 5 | Open Source | TalkHeal: AI Mental Health Support Assistant | [GitHub](https://github.com/eccentriccoder01/TalkHeal) |
| 6 | Open Source | Hia: Blood Report AI Analysis Agent | [GitHub](https://github.com/harshhh28/hia) |
